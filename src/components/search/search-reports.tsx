...
const SearchReports: React.FC<SearchProps> = ({ isOpen, onClose, setReport, disabled, val, children }) => {
            ...
            if (item.children?.length > 0) {
                item.children?.forEach((children) => {
                    menuItems_.push({
                        ...
                        detailsIncluded: children.detailsIncluded,
                        isActive: children.isActive,
                        viewInFastMenu: children.viewInFastMenu,
                        type: children.type
                    })
                });
            }
