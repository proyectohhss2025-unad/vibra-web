                ...
                <tbody>
                    {data.map((record) => (
                        <tr className={`mt-0 mb-0 hover:bg-blue-100 hover:rounded border-b`}
                            key={record._id}>
                            <td className="text-sm px-2 py-1.5">{record.title}</td>
                            <td className="text-sm px-2 py-1.5">{record.description}</td>
                            <td className="text-sm px-2 py-1.5">{record.emotion?.name || '-'}</td>
                            <td className="text-sm px-2 py-1.5">{record.difficulty}</td>
                            <td className="text-sm px-2 py-1.5">{record.resources?.length || 0}</td>
                            <td className="text-sm px-2 py-1.5">{record.questions?.length || 0}</td>
